...
{
    public interface ITextTemplateCrudRepository<T> : ICrudRepositoryBase<TextTemplateModel, long>
    {
        /// <summary>
        /// 모델 수정
        /// </summary>
    ...
    public interface ITextTemplateRepository : ITextTemplateCrudRepository<TextTemplateModel>
    {
        /// <summary>
        /// 필터링 옵션에 따른 조회
        /// </summary>
        Task<ArticleSet<TextTemplateModel, long>> GetByAsync<TParentIdentifier>(FilterOptions<TParentIdentifier> options);
